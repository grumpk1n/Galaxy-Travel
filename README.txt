We should also include a "calculation time" result to let the players know how long it takes for the ship to jump.
...
Difficulty modifier for Jump Distance *Done*
